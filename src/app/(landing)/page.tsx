...
export default function Home() {
  return (
    <main className="sidebar-layout__main flex justify-center flex-col">
      ...
      <p className="p-4">I enjoy mentoring junior developers, collaborating with cross-functional teams, and implementing agile methodologies to deliver user-friendly, maintainable, and high-performance software. I am always eager to learn and adopt new languages, frameworks, and tools to meet project needs and solve real-world problems.</p>
